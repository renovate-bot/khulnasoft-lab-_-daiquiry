...
class TestOutput(unittest.TestCase):
    ...
    def test_datadog(self) -> None:
        with mock.patch("socket.socket") as mock_socket:
            ...
            daiquiry.setup(outputs=(daiquiry.output.Datadog(),), level=logging.DEBUG)
            logger = daiquiry.getLogger()
            ...
            try:
                ...
                logger = daiquiry.getLogger("saymyname")
