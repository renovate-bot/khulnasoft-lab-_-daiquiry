...
class TestColorExtrasFormatter(unittest.TestCase):
    logger: daiquiry.KeywordArgumentAdapter
    stream: io.StringIO
    handler: daiquiry.handlers.TTYDetectorStreamHandler

    @classmethod
    def setUpClass(cls) -> None:
        cls.logger = daiquiry.getLogger("my_module")
        cls.logger.setLevel(logging.INFO)
        cls.stream = io.StringIO()
        cls.handler = daiquiry.handlers.TTYDetectorStreamHandler(cls.stream)
    ...
    def test_no_keywords(self) -> None:
        ...
        formatter = daiquiry.formatter.ColorExtrasFormatter(fmt=format_string)
